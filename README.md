# Horizon Rm Vision 26 ROS

 Horizon战队26赛季ROS视觉项目仓库，基于中南大学FYT战队24赛季视觉项目FYT_Vision_2024，该项目在原rm_vision项目上扩展了自瞄选板、能量机关识别与预测、哨兵定位、自主导航等功能，为RoboMaster机器人实现了一套通用的算法框架
...
M3:调整相机参数表内容，修复部分arm64设备使用大恒相机无法正常编译的问题，修改通信协议坐标系正负，修改开火协议，补充自瞄模式的UI绘制

M4:为能量机关识别模块增加对arm64设备的支持，修复部分arm64设备无法正常启动相机的问题,补充了部分相机的内参，修改终端输出,